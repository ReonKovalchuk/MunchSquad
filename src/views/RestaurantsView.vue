  ...
  <!-- <form>
    <div class="space-y-12">
      <div class="border-b border-gray-900/10 pb-12">
        <h2 class="text-base font-semibold leading-7 text-gray-900">Новый рецепт</h2>
            ...
            <div class="mt-2">
              ...
              >
                <input
                  ...
                  class="block flex-1 border-0 bg-transparent p-2 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
          ...
          <div class="col-span-full">
            ...
            <div class="mt-2">
              <textarea
                ...
                name="about"
                rows="3"
                class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-teal-600 sm:text-sm sm:leading-6"
              ></textarea>
            </div>
          </div>
          ...
          <div class="sm:col-span-3">
            ...
            <div class="mt-2">
              <select
                ...
                class="block w-full rounded-md border-0 p-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-teal-600 sm:max-w-xs sm:text-sm sm:leading-6"
              >
